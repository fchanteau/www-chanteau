...
export function NavBarClient() {
    ...
    return (
        <header className="fixed inset-x-0 top-0 px-6">
        <nav className="flex items-center justify-center p-4 z-50 relative mx-auto mt-2 max-w-400">
                    ...
                    return (
                        <li
                            ...
                            className={
                                ...
                                (isActive
                                    ? "backdrop-blur-xl bg-(--bg-backdrop)"
                                    : "")
                            }
                        >
